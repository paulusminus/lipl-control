...
/// Adds pattern-matching-related methods to [LyricPart].
extension LyricPartPatterns on LyricPart {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LyricPart value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LyricPart() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LyricPart value)  $default,){
final _that = this;
switch (_that) {
case _LyricPart():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LyricPart value)?  $default,){
final _that = this;
switch (_that) {
case _LyricPart() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int current,  int total,  String text,  String title)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LyricPart() when $default != null:
return $default(_that.current,_that.total,_that.text,_that.title);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int current,  int total,  String text,  String title)  $default,) {final _that = this;
switch (_that) {
case _LyricPart():
return $default(_that.current,_that.total,_that.text,_that.title);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int current,  int total,  String text,  String title)?  $default,) {final _that = this;
switch (_that) {
case _LyricPart() when $default != null:
return $default(_that.current,_that.total,_that.text,_that.title);case _:
  return null;
