...
bool operator ==(Object other) {
  final _this = this as Credentials;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Credentials&&(identical(other.username, _this.username) || other.username == _this.username)&&(identical(other.password, _this.password) || other.password == _this.password));
}
...
String toString() {
  final _this = this as Credentials;
  return 'Credentials(username: ${_this.username}, password: ${_this.password})';
}
