...
class _LiplRestApi implements LiplRestApi {
  ...
  Future<List<Lyric>> getLyrics() async {
    ...
    final _options = _setStreamType<List<Lyric>>(
  ...
  @override
  Future<void> putLyric(String id, Lyric lyric) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<List<Summary>> getPlaylistSummaries() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Summary>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'playlist',
  ...
  @override
  Future<void> putPlaylist(String id, Playlist playlist) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
